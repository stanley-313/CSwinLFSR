...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='./data_for_training/SR_5x5_4x/')
    parser.add_argument('--testset_dir', type=str, default='./data_for_test/SR_5x5_4x/')
    ...
    parser.add_argument('--model_path', type=str, default='./pth/CSWinLFSR_4xSR_5x5_epoch_49.pth.tar')
